...
class Trainer(object):
    def __init__(self,  weight_path, resume, gpu_id):
        ...
        #self.__load_model_weights(weight_path, resume=True)
    ...
    def train(self):
        ...
        iteration=0
        for epoch in range(20, self.epochs):
            self.yolov3.train()
            ...
            writer.add_scalar('loss_giou', mloss[0], epoch)
            writer.add_scalar('loss_conf', mloss[1], epoch)
            writer.add_scalar('loss_cls', mloss[2], epoch)
            writer.add_scalar('train_loss', mloss[3], epoch)
