...
def resize_bbox(bbox, in_size, out_size):
    ...
    """
    bbox = bbox.copy()
    y_scale = float(out_size[0]) / in_size[0]  #h_out/h_in
    x_scale = float(out_size[1]) / in_size[1]  #w_out/w_in
...
def crop_bbox(
    ...
    t, b = _slice_to_bounds(y_slice)  #0 inf
    l, r = _slice_to_bounds(x_slice)  # 0 inf
