...
trainer=Trainer(train_net,optimizer,save_dir="/root/yanjing/NN/mid_exam/checkpoint/cutout/")
train_loss,test_loss,test_acc=trainer.loop('cutout',50,train_iter,test_iter,schedular)

dirs="/root/yanjing/NN/mid_exam/result/cutout/"
